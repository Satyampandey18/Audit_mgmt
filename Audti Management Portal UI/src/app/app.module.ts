...
@NgModule({
  ...
  providers: [
    { provide: AuthURL, useValue: 'https://localhost:44311/api/Token' },
    {
      provide: QuesURL,
      useValue: 'https://localhost:44344/api/AuditChecklist',
    },
    {
      provide: SeverityURL,
      useValue: 'https://localhost:44303/api/AuditSeverity',
    },
  ],
